<template>
  <div class="patient-page">
    ...
    <div v-else class="patient-grid">
      <article v-for="item in matches" :key="item.id" class="patient-match-card">
        <div class="card-head">
          ...
          <span class="status" :class="item.compatibility">{{ item.compatibility_display }}</span>
        </div>
        <div class="simple-facts">
          ...
          <div><i class="ri-dna-line"></i><span>شباهت HLA</span><strong>{{ item.hla_similarity.matches }} از {{ item.hla_similarity.maximum }} آلل</strong></div>
